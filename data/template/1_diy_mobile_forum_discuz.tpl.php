...
0
|| checktplrefresh('./template/default/mobile/forum/discuz.htm', './template/default/mobile/common/header.htm', 1522244656, 'diy', './data/template/1_diy_mobile_forum_discuz.tpl.php', './template/default', 'mobile/forum/discuz')
|| checktplrefresh('./template/default/mobile/forum/discuz.htm', './template/default/mobile/common/footer.htm', 1522244656, 'diy', './data/template/1_diy_mobile_forum_discuz.tpl.php', './template/default', 'mobile/forum/discuz')
;?>
...
<?php if(!empty($_G['setting']['pluginhooks']['global_header_mobile'])) echo $_G['setting']['pluginhooks']['global_header_mobile'];?><?php if(!empty($_G['setting']['pluginhooks']['index_top_mobile'])) echo $_G['setting']['pluginhooks']['index_top_mobile'];?>
